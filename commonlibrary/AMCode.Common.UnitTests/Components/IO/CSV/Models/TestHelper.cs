...
namespace AMCode.Common.UnitTests.IO.CSV.Models
{
    internal class TestHelper : TestHelperBase
    {
        ...
        public override string GetTestDirectoryPath(TestContext testContext) => Path.Combine(testContext.TestDirectory, "Components", "IO", "CSV");
    }
}