...
namespace AMCode.Common.UnitTests.Filters.Models
{
    internal class TestHelper : TestHelperBase
    {
        ...
        public override string GetTestDirectoryPath(TestContext testContext) => Path.Combine(testContext.TestDirectory, "Components", "Filter");
    }
}