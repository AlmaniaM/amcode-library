# DemandLink Excel Document Builder Library

This project provides an interface for easily creating Excel documents.
...
1. **Xlsx Library License**
    - Name: **DL_XLSX_LIBRARY_LICENSE**
    - Value: Can be found in TS01/C:/Development/c-crts.txt
