...
/// <summary>
/// Configuration for OpenAI OCR provider (using GPT-4o vision capabilities)
/// </summary>
public class OpenAIOCRConfiguration
{
    /// <summary>
    /// OpenAI API key
    /// </summary>
    ...
    /// <summary>
    /// Model to use for OCR requests (e.g., gpt-4o, gpt-4o-2024-08-06, gpt-4o-mini)
    /// </summary>
    ...
    {
        "en", "es", "fr", "de", "it", "pt", "nl", "pl", "ru", "zh", "ja", "ko", "ar", "hi"
    };

    /// <summary>
    /// Cost per input token in USD (GPT-4o pricing)
    /// </summary>
    public decimal CostPerInputToken { get; set; } = 0.0000025m;

    /// <summary>
    /// Cost per output token in USD (GPT-4o pricing)
    /// </summary>
    ...
    /// <summary>
    /// Detail level for vision requests (low, high, auto)
    /// </summary>
