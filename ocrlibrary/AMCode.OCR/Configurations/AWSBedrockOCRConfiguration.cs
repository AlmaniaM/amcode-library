...
/// <summary>
/// Configuration for AWS Bedrock OCR models
/// </summary>
public class AWSBedrockOCRConfiguration
{
    /// <summary>
    /// The AWS region
    /// </summary>
    ...
    /// <summary>
    /// The AWS Bedrock model to use for OCR (e.g., "anthropic.claude-3-5-sonnet-20241022-v2:0")
    /// </summary>
