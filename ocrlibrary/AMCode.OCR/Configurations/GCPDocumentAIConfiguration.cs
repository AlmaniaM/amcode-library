...
/// <summary>
/// Configuration for Google Cloud Document AI OCR
/// 
/// NOTE: This is a placeholder configuration for future implementation.
/// The provider implementation does not exist yet.
/// </summary>
public class GCPDocumentAIConfiguration
{
    /// <summary>
    ...
    /// <summary>
    /// The Google Cloud Document AI endpoint (optional, uses default if not specified)
    /// </summary>
