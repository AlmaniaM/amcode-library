...
public class AzureComputerVisionOCRServiceTests
{
    ...
    public void Capabilities_ShouldReturnCorrectCapabilities()
    {
        ...
        capabilities.MaxImageSizeMB.Should().Be(50); // 50MB
    ...
    public async Task ProcessImageAsync_WithMultipleLines_ShouldProcessAllLines()
    {
                ...
                ReadResults = new List<ReadResult>
                {
                    new ReadResult
                    {
                        ...
                        Lines = new List<Line>
                        {
                            ...
                            {
                                Text = "Second line",
                                BoundingBox = new List<double?> { 10, 50, 100, 50, 100, 70, 10, 70 }
                            }
                        }
                    }
                }
        ...
        result.TextBlocks[0].Text.Should().Be("First line");
                ...
                ReadResults = new List<ReadResult>
                {
                    new ReadResult
                    {
                        ...
                        Lines = new List<Line>
                        {
                            ...
                            {
                                Text = "Sample text",
                                BoundingBox = new List<double?> { 10, 20 } // Invalid - not enough points
                            }
                        }
                    }
                }
