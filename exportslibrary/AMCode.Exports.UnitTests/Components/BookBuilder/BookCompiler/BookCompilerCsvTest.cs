...
namespace DlExportsLibrary.UnitTests.BookBuilder.BookCompilerTests
{
    ...
    public class BookCompilerCsvTest
    {
        ...
        public void SetUp()
        {
            ...
            columns = Enumerable.Range(1, 1).Select(index => new CsvDataColumn { WorksheetHeaderName = $"Column{index}" });
        ...
        public async Task ShouldCreateSingleCsvBook()
        {
            ...
            Assert.AreEqual(FileType.Csv, result.FileType);
        ...
        public async Task ShouldCreateZipOfCsvBooks()
        {
            ...
            var result = await bookCompiler.CompileCsvAsync("TestBook", 100, columns, new CancellationToken());
