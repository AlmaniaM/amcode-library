...
## **🚨 MANDATORY UPDATE REQUIREMENT FOR EXECUTING LLMs**

**CRITICAL**: When an LLM is executing tasks from a planning document, it **MUST** update the planning document after **EVERY task completion** to ensure seamless handoff to the next LLM session.

### **Mandatory Update Protocol**

**After completing ANY task:**
1. **IMMEDIATELY update the planning document** with the task completion status
2. **Mark the task as ✅ Complete** in the "What's Left" section
3. **Update task counters** (e.g., 3/5 → 4/5) in the progress table
4. **Update "Currently Working On"** to the next task or mark as complete
5. **Update "Last Updated" timestamp** to current date/time
6. **Add completion note** with brief description of what was accomplished
7. **Update "What We've Done" section** with completed task details
8. **Update files modified** if any files were created, modified, or deleted

**This update MUST happen automatically after every task - no exceptions.**

### **Why This Is Critical**

- **Seamless Handoff**: Next LLM can immediately see where previous LLM left off
- **Progress Tracking**: Accurate, real-time progress tracking across sessions
- **Context Preservation**: Complete context is preserved for continuation
- **No Lost Work**: Prevents work duplication or confusion about task status
- **Multi-Session Continuity**: Enables multiple LLMs to work on the same plan

### **Update Checklist After Each Task**

- [ ] Task marked as ✅ Complete in task breakdown
- [ ] Task counter updated in progress table
- [ ] "Currently Working On" updated to next task
- [ ] "Last Updated" timestamp refreshed
- [ ] Completion note added with brief summary
- [ ] Files modified list updated if applicable
- [ ] "What We've Done" section updated
- [ ] Next steps are clear and actionable

**Failure to update the planning document after task completion will result in context loss and handoff failures.**
...
**⚠️ MANDATORY FOR EXECUTING LLMs: Update After Every Task Completion**
...
**Completing a Task:**
- **🚨 MANDATORY**: Update planning document IMMEDIATELY after task completion
- Mark task as ✅ Complete
- Update task counter (e.g., 3/5 → 4/5)
- Add brief completion note
- Update "Currently Working On" to next task
- Update "Last Updated" timestamp
- Update "What We've Done" section with task details
- Update files modified list if applicable
- **Run `/save-plan` to persist changes**
- **This is NOT optional - it is required for multi-session continuity**
