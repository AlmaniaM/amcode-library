...
namespace DlCommonTestingLibrary.UnitTests.IO.CsvDataReaderTests.Models
{
    class LocalTestHelpers
    {
        ...
        public static string GetTestDirectoryPath(TestContext testContext) => Path.Combine(testContext.TestDirectory, "Components", "IO");
